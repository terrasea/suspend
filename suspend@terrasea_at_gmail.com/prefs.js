...
const Gettext = imports.gettext.domain('gnome-shell-extensions-suspend');
...
const SuspendPrefsWidget = new GObject.Class({
    Name: 'Suspend.Prefs.Widget',
    GTypeName: 'SystemPrefsWidget',
    Extends: Gtk.Frame,
...
function buildPrefsWidget() {
    let widget = new SuspendPrefsWidget();
    widget.show_all();
